...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-black text-white py-16 lg:py-20">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* RIGHT SIDE — NCM 3D IMAGE */}
          
<div className="relative w-full h-[500px] lg:h-[520px] overflow-hidden rounded-sm bg-black">
            <img
              src="/ncm-hero.png"
              alt="NCM Studio Premium Creative Marketplace"
